...
{
VK_BACK,	__T("Back Space"),
VK_TAB,		__T("Tab"),
VK_CLEAR,	__T("Clear"),
VK_RETURN,	__T("Enter"),
VK_PAUSE,	__T("Pause"),
VK_CAPITAL,	__T("Caps Lock"),
VK_ESCAPE,	__T("Esc"),
VK_SPACE,	__T("Space"),
VK_PRIOR,	__T("Page Up"),
VK_NEXT,	__T("Page Down"),
...
VK_RIGHT,	__T("Right"),
VK_DOWN,	__T("Down"),
VK_SELECT,	__T("Select"),
VK_SNAPSHOT,__T("Print Screen"),
VK_INSERT,	__T("Insert"),
VK_DELETE,	__T("Delete"),
...
0x59,		__T("y"),
0x5A,		__T("z"),
VK_NUMPAD0,	__T("Numpad 0"),
VK_NUMPAD1, __T("Numpad 1"),
VK_NUMPAD2, __T("Numpad 2"),
VK_NUMPAD3, __T("Numpad 3"),

VK_NUMPAD4, __T("Numpad 4"),
VK_NUMPAD5, __T("Numpad 5"),
VK_NUMPAD6, __T("Numpad 6"),
VK_NUMPAD7, __T("Numpad 7"),
VK_NUMPAD8, __T("Numpad 8"),
VK_NUMPAD9, __T("Numpad 9"),
VK_MULTIPLY,__T("Numpad *"),
VK_ADD,		__T("Numpad +"),
VK_SUBTRACT, __T("Numpad -"),
VK_DECIMAL,  __T("Numpad ."),

VK_DIVIDE,	__T("Numpad /"),
VK_F1,		__T("f1"),
VK_F2,		__T("f2"),
VK_F3,		__T("f3"),
VK_F4,		__T("f4"),
