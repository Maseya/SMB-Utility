...
#define SMB_FLOWER 0x98F5   // 5バイト (5 bytes)
#define SMB_POLEGFX 0x8C60  // 4バイト (4 bytes)
...
// LRESULT CALLBACK LoopWizardDlgProc(HWND hDlg,UINT message,WPARAM wParam,LPARAM
// lParam);
