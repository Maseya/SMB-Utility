...
This text becomes easier to read by checking [Edit] - [Wrap at right end] in Notepad.
...
§ 3 license
SMB Utility (hereinafter referred to as this software) is freeware. The copyright of this software belongs to M.K.S (hereinafter referred to as the author). Reprinting / distribution of this software (as long as the license of the Multi - 6502 CPU emulator used internally) can be freely carried out only for non - commercial use, it is strictly prohibited to bundle the game ROM file To do. In addition, the author is not obligated to compensate for any damage caused by using this software.
...
1.08 I translate SMB Utility English Version 1.07 created by Mirracle MXX in English into English translation.
